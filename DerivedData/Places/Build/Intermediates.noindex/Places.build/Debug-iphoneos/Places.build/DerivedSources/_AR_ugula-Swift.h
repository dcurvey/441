...
SWIFT_MODULE_NAMESPACE_PUSH("_AR_ugula")
@class CLLocation;
@class ARAnnotationView;

/// Defines POI with title and location.
SWIFT_CLASS("_TtC9_AR_ugula12ARAnnotation")
...
SWIFT_CLASS("_TtC9_AR_ugula16ARAnnotationView")
...
SWIFT_PROTOCOL("_TtP9_AR_ugula12ARDataSource_")
...
SWIFT_CLASS("_TtC9_AR_ugula17ARTrackingManager")
...
SWIFT_PROTOCOL("_TtP9_AR_ugula25ARTrackingManagerDelegate_")
...
SWIFT_CLASS("_TtC9_AR_ugula16ARViewController")
...
SWIFT_CLASS("_TtC9_AR_ugula14AnnotationView")
...
SWIFT_CLASS("_TtC9_AR_ugula22DebugMapViewController")
...
SWIFT_CLASS("_TtC9_AR_ugula5Place")
...
SWIFT_CLASS("_TtC9_AR_ugula15PlaceAnnotation")
...
@interface ViewController (SWIFT_EXTENSION(_AR_ugula)) <CLLocationManagerDelegate>
- (BOOL)locationManagerShouldDisplayHeadingCalibration:(CLLocationManager * _Nonnull)manager SWIFT_WARN_UNUSED_RESULT;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
@end
