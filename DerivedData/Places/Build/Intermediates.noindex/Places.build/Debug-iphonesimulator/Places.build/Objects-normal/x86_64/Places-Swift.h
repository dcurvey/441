...
SWIFT_MODULE_NAMESPACE_PUSH("Places")
@class CLLocation;
@class ARAnnotationView;

/// Defines POI with title and location.
SWIFT_CLASS("_TtC6Places12ARAnnotation")
...
SWIFT_CLASS("_TtC6Places16ARAnnotationView")
...
SWIFT_PROTOCOL("_TtP6Places12ARDataSource_")
...
SWIFT_CLASS("_TtC6Places17ARTrackingManager")
...
SWIFT_PROTOCOL("_TtP6Places25ARTrackingManagerDelegate_")
...
SWIFT_CLASS("_TtC6Places16ARViewController")
...
SWIFT_CLASS("_TtC6Places22DebugMapViewController")
...
SWIFT_CLASS("_TtC6Places5Place")
@interface Place : ARAnnotation
...
- (nonnull instancetype)initWithLocation:(CLLocation * _Nonnull)location reference:(NSString * _Nonnull)reference name:(NSString * _Nonnull)name address:(NSString * _Nonnull)address OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC6Places15PlaceAnnotation")
...
SWIFT_CLASS("_TtC6Places14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(Places)) <ARDataSource>
- (ARAnnotationView * _Nonnull)ar:(ARViewController * _Nonnull)arViewController viewForAnnotation:(ARAnnotation * _Nonnull)viewForAnnotation SWIFT_WARN_UNUSED_RESULT;
@end


@interface ViewController (SWIFT_EXTENSION(Places))
- (void)didTouchWithAnnotationView:(AnnotationView * _Nonnull)annotationView;
@end


@interface ViewController (SWIFT_EXTENSION(Places)) <CLLocationManagerDelegate>
